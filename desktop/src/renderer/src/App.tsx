...
import CreateCategoryView from './views/categories/create/view'
import EditCategoryView from './views/categories/edit-id/view'
import CategoryDetailsView from './views/categories/details-id/view'
...
function App(): JSX.Element {
  ...
  return (
    <Switch>
      ...
      <Route path={Routes.CategoriesCreate} component={CreateCategoryView} />
      <Route path={Routes.CategoriesEdit} component={EditCategoryView} />
      <Route path={Routes.CategoriesDetails} component={CategoryDetailsView} />
